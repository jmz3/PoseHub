...
void ObjectInformation::setPose(double x, double y, double z, double qx, double qy, double qz, double qw)
{
...
void ObjectInformation::setVelocity(double vx, double vy, double vz, double wx, double wy, double wz)
{
...
void ObjectInformation::setAcceleration(double ax, double ay, double az, double awx, double awy, double awz)
{
...
ObjectRandomMotionEngine::ObjectRandomMotionEngine(std::string const &name, const double &T, const double &MAX_P, const double &MAX_V, const double &MAX_A)
{
    ...
    q = tf2::Quaternion(object.pose.orientation.x, object.pose.orientation.y, object.pose.orientation.z, object.pose.orientation.w);
}
...
void ObjectRandomMotionEngine::update()
{
    ...
    // This is a "fake" implementation, it should be replaced by a proper quaternion integration
    // This is a pure quaternion with no scalar part
    q += tf2::Quaternion(object.velocity.angular.x * deltaT, object.velocity.angular.y * deltaT, object.velocity.angular.z * deltaT, 0);
    q.normalize();
